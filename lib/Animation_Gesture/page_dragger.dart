...
class _PageDraggerState extends State<PageDragger> {
  ...
  Widget build(BuildContext context) {
    ...
    if(widget.slideUpdateStream != null) {
    return GestureDetector(
      ...
      //onHorizontalDragStart: onDragStart : DragStartBehavior.start,
      //onHorizontalDragUpdate: widget.slideUpdateStream != null ? onDragUpdate,
      //onHorizontalDragEnd: widget.slideUpdateStream != null ? onDragEnd,
    );
    }
  }
}
