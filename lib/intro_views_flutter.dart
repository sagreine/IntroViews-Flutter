...
class IntroViewsFlutter extends StatefulWidget {
  ...
  final int activePageIndex_start;
...
class _IntroViewsFlutterState extends State<IntroViewsFlutter>
  ...
  int activePageIndex; // = widget.activePageIndex_start; //active page index
  ...
  void initState() {
    ...
    activePageIndex = widget.activePageIndex_start;
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
         ...
         //IgnorePointer(
//ignoring: (pages[activePageIndex].childMainImageAbsorbsDrag ?? false),
          ...
          PageDragger(
            ...
            slideUpdateStream: (!pages[activePageIndex].childMainImageAbsorbsDrag ?? true) ? this.slideUpdateStream : null,
          ), //PageDragger
         //),
        ], //Widget
      ), //Stack
